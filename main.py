...
tl_admin_users = ['Krixt0'] #Poner aqui los user con acceso permanente
godlist = ['Krixt0','JMiguel07','MelodicSpinach','DTB86','KiritoOMG'] #Poner aqui los admin 
...
async def onmessage(bot:TelegramClient,ev: NewMessage.Event,loop,ret=False):
    ...
    if '/start' in text:
        ...
        reply += '<a href="https://t.me/Krixt0">Soporte</a>'
